        ...
        <div class="comments">
					...
					<!-- if logged in -->
						<div class="post_comment">
							<form method="post" action="index.php?page=news&mode=create" id="quick-comment">
								<input type="text" name="subject" placeholder="Enter the subject..." id="text"><br><br>
								<textarea placeholder="Type in your news text..." name="text" id="textarea"></textarea>
								<input type="submit" value="Add news" />
							</form>
						</div>
					 <!-- if logged in.end -->            
            <div class="comments-cont">
            	IMPORTANT: you have to upload a news image in /uploads/news/ with as image name the ID of the news !
