    ...
    <div class="footer-holder">
        <div id="footer">
            ...
            <div class="right-side">
                <ul>
                	<li><a href="index.php?page=media&mode=allwallpapers">{$LNG.custom_p2}</a></li>
                    <li><a href="index.php?page=media&mode=allvideos">{$LNG.custom_p3}</a></li>
                    <li><a href="index.php?page=media&mode=allscreenshots">{$LNG.siteTitleScreens}</a></li>
                </ul>
            	...
            	<ul>
                    ...
                    <li><a href="http://forum.warofalliance.eu" target="_blank">{$LNG.forum}</a></li>
                </ul>
            </div>
            
        </div>
        <div class="bot-foot-border">
			Design by <a href="#">MakeYourGame</a><br>
		</div>
