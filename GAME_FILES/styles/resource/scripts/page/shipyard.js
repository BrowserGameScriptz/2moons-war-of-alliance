var HTMLadd			='',
	...
	QueueTimerDOM	=		// DOM Ñ‚Ð°Ð¹Ð¼Ðvar HTMLadd			='',
	ActivTab		='',
	v  				= new Date(), 
	progress		= 
	FlagKey			= 
...
function counting(id)
{
	...
	if(count > Data.maxBuildable)
	{
		count = Data.maxBuildable;
		Element.find('.build-count-input:first').val(Data.maxBuildable);
	}
	...
	{
		CalcRess(921, Number(Data.costRessources[921]) * count, CurRes[921][0], Element)
	}
