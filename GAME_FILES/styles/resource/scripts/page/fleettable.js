...
function doit(planetID, sleeve, system, planet, shipData) 
{
	var shipDetail	= decodeURIComponent($.param({"ship": shipData}));
	
	$.getJSON("game.php?page=fleetAjax&ajax=1&mission=6&planetID="+planetID+"&sleeve="+sleeve+"&system="+system+"&planet="+planet+"&"+shipDetail, function(data){
