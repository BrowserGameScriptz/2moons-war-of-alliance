        ...
        <div id="block1-container">
            <div id="block1-group" data-group-name="block1" class="panel panel-widget icon-menu-section" role="category">
                <div class="panel-heading widget-heading" ng-dblclick="toggleGroup(block1)">
                    <span id="block1-header" class="group-header">Galaxy Settings</span>
                    ...
                    <div class="icon-container-body">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="input-group">
										...
										<span id="atSignAddEmailAccount" class="input-group-addon">@</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="input-group">
										<input type="text" name="max_planets" value="{$max_planets}" class="form-control" readonly>
										<span id="atSignAddEmailAccount" class="input-group-addon">@</span>
									</div>
								</div>
							</div>
