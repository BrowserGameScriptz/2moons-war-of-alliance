...
class BuildFunctions
{
    ...
    public static function getBuildingTime($USER, $PLANET, $Element, $elementPrice = NULL, $forDestroy = false, $forLevel = NULL)
    {
        ...
        if	   (in_array($Element, $reslist['build'])) {
			...
			$elementCost	= $elementPrice[941];
            $time	= $elementCost / ($USER['research_perhour']+15);
        }
	...
	public static function getMaxElementsToList($PLANET)
    {
        return config::get()->max_elements_build;
    }

	public static function getMaxElementsResearch($PLANET)
    {
        return config::get()->max_elements_tech;
    }

	public static function getMaxElementsNaval($PLANET)
    {
        return config::get()->max_elements_ships;
    }
