...
class MissionCaseSpy extends MissionFunctions implements Mission
{
	...
	function TargetEvent()
	{
		...
		if($SpyFleet) 
		{
			$classIDs[200]	= array(210,212,202,209,203,208,204,205,229,206,207,215,213,211,224,214,225,216,218,226,230,222,221);
		}
		
		if($SpyDef) 
		{
			$classIDs[400]	= array(407,408,409,402,403,420,405,404,412,406,416,421,417,410,413,418,419,422,415);
		}
		
		if($SpyBuild) 
		{
			$classIDs[0]	= array(1,2,3,4,12,31,14,21,15,16,22,23,24,33,34);
		}
		
		if($SpyTechno) 
		{
			$classIDs[100]	= array(101,102,103,104,105,106,109,110,111,113,115,116,117,118,120,121,122,124,141,142,143,144,151,152,153,154,155,156,157,158,165,171,172,173,174,199);
		}
