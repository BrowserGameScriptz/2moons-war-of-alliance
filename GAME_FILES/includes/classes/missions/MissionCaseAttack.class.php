...
class MissionCaseAttack extends MissionFunctions implements Mission
{
	...
	{	
		...
		$messageHTML	= <<<HTML
<a href="CombatReport.php?raport=%s" class="msg-btn-more btn btn-primary" target="_blank">%s</a>
<div class="msg-title">%s [%s %s (%s)]</div>
<div class="f-f-b f-ta-c c-red">%s</div>
<div class="ms-bt-totals">
	<div class="ms-bt-totals-bar bga-red2">
		<div class="ms-bt-totals-points">%s</div>
		<div class="ms-bt-totals-bar-bg bga-red2" style="width:%s; right:0;"></div>
	</div>
	<div class="ms-bt-totals-bar bga-902">
		<div class="ms-bt-totals-points">%s</div>
		<div class="ms-bt-totals-bar-bg bga-902" style="width:%s; left:0;"></div>
	</div>
</div>
<div class="f-f-b">Добыча:</div>

<div class="msg-res-rows">
	<div class="msg-res-row c-901">210<div class="msg-res-row-i ri i-901" title="%s"></div></div>
	<div class="msg-res-row c-902">210<div class="msg-res-row-i ri i-902" title="%s"></div></div>
	<div class="msg-res-row c-903">0<div class="msg-res-row-i ri i-903" title="%s"></div></div>
</div>
HTML;
...
<div class="f-f-b">%s:</div>

<div class="msg-res-rows">
	<div class="msg-res-row c-901">%s<div class="msg-res-row-i ri i-901" title="%s"></div></div>
	<div class="msg-res-row c-902">%s<div class="msg-res-row-i ri i-902" title="%s"></div></div>
	<div class="msg-res-row c-903">%s<div class="msg-res-row-i ri i-903" title="%s"></div></div>
</div>
HTML;
