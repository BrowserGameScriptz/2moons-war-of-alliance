...
class FleetFunctions 
{
	...
	public static function GetShipConsumption($Ship, $Player)
	{
		global $pricelist;
	...
	{
		return $USER[$GLOBALS['resource'][154]];
	}
	...
	{
		global $resource;
		return 1 + $USER[$resource[101]] + $USER['factor']['FleetSlots'];
	}
	...
	public static function GetFleetMissions($USER, $MisInfo, $Planet)
	{
		...
		if(in_array(16, $Missions)) 
		{
			$stayBlock = array(1 => 1, 2 => 2, 4 => 4, 8 => 8, 12 => 12, 16 => 16, 32 => 32);
		}elseif (in_array(15, $Missions)) {
