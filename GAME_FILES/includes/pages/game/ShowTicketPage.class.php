...
class ShowTicketPage extends AbstractGamePage
{
	...
	function view() 
	{
		...
		$sql = "SELECT a.*, t.categoryID, t.status, t.ownerID as ticketCreator FROM %%TICKETS_ANSWER%% a INNER JOIN %%TICKETS%% t USING(ticketID) WHERE a.ticketID = :ticketID ORDER BY a.answerID;";
