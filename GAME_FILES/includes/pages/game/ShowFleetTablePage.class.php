	...
	public function show()
	{
		...
		foreach ($fleetResult as $fleetsRow)
		{
			...
			$FlyingFleetList[]	= array(
				...
				'missionName'	=> $LNG['type_mission_'.$fleetsRow['fleet_mission']],
		...
		if(!isset($_COOKIE['_m1o'])) setcookie("_m1o", 0);
		if(!isset($_COOKIE['_m2o'])) setcookie("_m2o", 0);
		if(!isset($_COOKIE['_m3o'])) setcookie("_m3o", 0);
		if(!isset($_COOKIE['_m4o'])) setcookie("_m4o", 0);
		if(!isset($_COOKIE['_m5o'])) setcookie("_m5o", 0);
		if(!isset($_COOKIE['_m7o'])) setcookie("_m7o", 0);
		if(!isset($_COOKIE['_m8o'])) setcookie("_m8o", 0);
		if(!isset($_COOKIE['_m9o'])) setcookie("_m9o", 0);
		if(!isset($_COOKIE['_m16o'])) setcookie("_m16o", 0);
		if(!isset($_COOKIE['_m15o'])) setcookie("_m15o", 0);
		if(!isset($_COOKIE['_m3t'])) setcookie("_m3t", 0);
		if(!isset($_COOKIE['_m5t'])) setcookie("_m5t", 0);
		if(!isset($_COOKIE['_m1t'])) setcookie("_m1t", 0);
		if(!isset($_COOKIE['_m2t'])) setcookie("_m2t", 0);
		if(!isset($_COOKIE['_m9t'])) setcookie("_m9t", 0);
		
		$this->assign(array(
			'_m1o'						=> isset($_COOKIE['_m1o']) ? $_COOKIE['_m1o'] : 0,
			'_m2o'						=> isset($_COOKIE['_m2o']) ? $_COOKIE['_m2o'] : 0,
			'_m3o'						=> isset($_COOKIE['_m3o']) ? $_COOKIE['_m3o'] : 0,
			'_m4o'						=> isset($_COOKIE['_m4o']) ? $_COOKIE['_m4o'] : 0,
			'_m5o'						=> isset($_COOKIE['_m5o']) ? $_COOKIE['_m5o'] : 0,
			'_m7o'						=> isset($_COOKIE['_m7o']) ? $_COOKIE['_m7o'] : 0,
			'_m8o'						=> isset($_COOKIE['_m8o']) ? $_COOKIE['_m8o'] : 0,
			'_m9o'						=> isset($_COOKIE['_m9o']) ? $_COOKIE['_m9o'] : 0,
			'_m16o'						=> isset($_COOKIE['_m16o']) ? $_COOKIE['_m16o'] : 0,
			'_m15o'						=> isset($_COOKIE['_m15o']) ? $_COOKIE['_m15o'] : 0,
			'_m3t'						=> isset($_COOKIE['_m3t']) ? $_COOKIE['_m3t'] : 0,
			'_m5t'						=> isset($_COOKIE['_m5t']) ? $_COOKIE['_m5t'] : 0,
			'_m1t'						=> isset($_COOKIE['_m1t']) ? $_COOKIE['_m1t'] : 0,
			'_m2t'						=> isset($_COOKIE['_m2t']) ? $_COOKIE['_m2t'] : 0,
			'_m9t'						=> isset($_COOKIE['_m9t']) ? $_COOKIE['_m9t'] : 0,
		...
		if($modal == 1)
			$this->display('page.fleetTable.modal.tpl');
		else
