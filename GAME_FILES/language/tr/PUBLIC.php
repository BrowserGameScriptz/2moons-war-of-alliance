...
$LNG['custom_p1']					= 'Facebook\'ta İttifak Savaşı\'ndan hoşlandın';
$LNG['custom_p2']					= 'Duvar';
$LNG['custom_p3']					= 'Videolar';
$LNG['custom_p4']					= 'Eklentileri';
$LNG['custom_p5']					= 'Kullanım Şartları';
$LNG['custom_p6']					= 'Referanslar';
$LNG['custom_p7']					= 'Changelogs';
$LNG['custom_p8']					= 'Hesap adı';
$LNG['custom_p9']					= 'Beni hatırla';
$LNG['custom_p10']					= 'Parolanızı mı unuttunuz ?';
$LNG['custom_p11']					= 'Hala bir hesabınız yok mu? <a href="index.php?page=register">Şimdi üye Ol!</a>';
$LNG['custom_p12']					= 'İttifak Savaşı© ve WOA©, GetAGame\'nin Belçika\'daki ve/veya diğer ülkelerdeki<br> ticari markaları veya tescilli ticari markalarıdır. Bu şartlar ve ilgili tüm malzemeler<br>, logolar, resimler ve resimler telif hakkına sahiptir GetAGame©.';
$LNG['custom_p13']					= 'Anahtar kelimeleri ara';
$LNG['custom_p14']					= 'İttifak Savaşı [WOA] GM Recruitment';
$LNG['custom_p15']					= 'İttifak Savaşı\'na hoş geldiniz';
$LNG['custom_p16']					= 'İttifak Savaşı, en iyi eğlencenin tadını çıkarmak için yetenekli geliştiricileri ve kaynakları kullanan kaliteli bir sunucudur. Ekibimiz, oyuncular için günlük özellikleri profesyonelce yaratan ve koruyan özel bir ekiptir. Bugün kayıt Ol!';
$LNG['custom_p17']					= 'Son Haberler';
$LNG['custom_p18']					= 'Arşivlenmiş haber';
$LNG['custom_p19']					= 'Daha fazla oku';
$LNG['custom_p20']					= 'En Yeni Video';
$LNG['custom_p21']					= 'Tüm Videolar';
$LNG['custom_p22']					= 'Yeni Ekran Görüntüleri';
$LNG['custom_p23']					= 'Tüm Ekran Görüntüleri';
$LNG['custom_p24']					= 'En Çok Seçmenler';
$LNG['custom_p25']					= '! Her Ayı Sıfırla';
$LNG['custom_p26']					= 'Aylık ödüller En Yüksek Seçmenlere verilecek.
Top 5 için 500 gümüş sikke ve üst 3 için ek olarak 25 altın para.';
$LNG['custom_p27']					= 'Spot';
$LNG['custom_p28']					= 'Medya';
$LNG['custom_p29']					= 'Hepsini gör';
$LNG['custom_p30']					= 'YouTube\'da izleyin';
$LNG['custom_p31']					= 'Hesap adı';
$LNG['custom_p32']					= 'Ekran adı';
$LNG['custom_p33']					= 'Doğum günü';
$LNG['custom_p34']					= 'Yıl';
$LNG['custom_p35']					= 'Gün';
$LNG['custom_p36']					= 'Ay';
$LNG['custom_p37']					= 'Ülke';
$LNG['custom_p38']					= 'Ülke Seçiniz';
$LNG['custom_p39']					= 'Gizli soru';
$LNG['custom_p40']					= 'Soru Seç';
$LNG['custom_p41']					= 'Doğum şehiriniz mi var?';
$LNG['custom_p42']					= 'Annenin doğum şehri?';
$LNG['custom_p43']					= 'Babanın doğum şehri mi?';
$LNG['custom_p44']					= 'İlk arabanın modeli?';
$LNG['custom_p45']					= 'Lisede en iyi arkadaşın';
$LNG['custom_p46']					= 'İlk katıldığım ilkokul muydu?';
$LNG['custom_p47']					= 'İlk evcil hayvanınızın adı?';
$LNG['custom_p48']					= 'Gizli Cevap';
$LNG['custom_p49']					= 'Daha eski';
$LNG['custom_p50']					= 'Daha yeni';
$LNG['custom_p51']					= 'Ayy';
$LNG['custom_p52']					= 'Bu haber yok!';
$LNG['custom_p53']					= 'Ayrıca, bu kurallar, belirli suistimal davranışlarına da uygulanır, suçların değişik biçimlerini idare edebilmek için önceden haber vermeden var olanları değiştirme veya yeni kurallar ekleme hakkını saklı tutarız (ve bunları listeye koymadan). Ayrıca, herhangi bir kullanıcının herhangi bir zamanda hizmetini reddetme veya iptal etme hakkını saklı tutarız.';
