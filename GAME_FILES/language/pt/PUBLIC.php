...
$LNG['custom_p1']					= 'Você gostou da Guerra da Aliança no Facebook';
$LNG['custom_p2']					= 'Papeis de parede';
$LNG['custom_p3']					= 'Vídeos';
$LNG['custom_p4']					= 'Addons';
$LNG['custom_p5']					= 'Termos de uso';
$LNG['custom_p6']					= 'Referências';
$LNG['custom_p7']					= 'Changelogs';
$LNG['custom_p8']					= 'Nome da conta';
$LNG['custom_p9']					= 'Lembre de mim';
$LNG['custom_p10']					= 'Esqueceu sua senha ?';
$LNG['custom_p11']					= 'Não tem uma conta ainda ? <a href="index.php?page=register">Registrar agora!</a>';
$LNG['custom_p12']					= 'War of Alliance© e WOA© são marcas registradas ou marcas registradas da GetAGame<br> na Bélgica e/ou em outros países. Estes termos e todos os materiais, logotipos, imagens<br> e imagens relacionadas são copyright GetAGame©.';
$LNG['custom_p13']					= 'Pesquisar palavras-chave';
$LNG['custom_p14']					= 'Guerra da Aliança [WOA] Recrutamento GM';
$LNG['custom_p15']					= 'Bem-vindo à Guerra da Aliança';
$LNG['custom_p16']					= 'A War of Alliance é um servidor de qualidade que utiliza desenvolvedores e recursos talentosos para garantir a melhor experiência divertida. Nossa equipe é uma equipe dedicada que cria e mantém características diárias para os jogadores. Cadastre-se hoje!';
$LNG['custom_p17']					= 'Últimas notícias';
$LNG['custom_p18']					= 'Notícias arquivadas';
$LNG['custom_p19']					= 'consulte Mais informação';
$LNG['custom_p20']					= 'Vídeo mais novo';
$LNG['custom_p21']					= 'Todos os vídeos';
$LNG['custom_p22']					= 'Novas Imagens';
$LNG['custom_p23']					= 'Todas as Imagens';
$LNG['custom_p24']					= 'Principais eleitores';
$LNG['custom_p25']					= '! Redefinir todos os meses';
$LNG['custom_p26']					= 'Recompensas mensais serão entregues aos principais eleitores.
500 moedas de prata para o Top 5 e mais 25 moedas de ouro para o top 3.';
$LNG['custom_p27']					= 'Holofote';
$LNG['custom_p28']					= 'meios de comunicação';
$LNG['custom_p29']					= 'Ver tudo';
$LNG['custom_p30']					= 'Assista no YouTube';
$LNG['custom_p31']					= 'Nome da conta';
$LNG['custom_p32']					= 'Mostrar nome';
$LNG['custom_p33']					= 'Aniversário';
$LNG['custom_p34']					= 'Ano';
$LNG['custom_p35']					= 'Dia';
$LNG['custom_p36']					= 'Mês';
$LNG['custom_p37']					= 'País';
$LNG['custom_p38']					= 'Selecione o pais';
$LNG['custom_p39']					= 'pergunta secreta';
$LNG['custom_p40']					= 'Seleccionar pergunta';
$LNG['custom_p41']					= 'Sua cidade de nascimento?';
$LNG['custom_p42']					= 'A cidade de nascimento da mãe?';
$LNG['custom_p43']					= 'A cidade de nascimento do pai?';
$LNG['custom_p44']					= 'Modelo do seu primeiro carro?';
$LNG['custom_p45']					= 'Melhor amiga do ensino médio?';
$LNG['custom_p46']					= 'Primeira escola primária em que participei?';
$LNG['custom_p47']					= 'Nome do seu primeiro animal de estimação?';
$LNG['custom_p48']					= 'Resposta secreta';
$LNG['custom_p49']					= 'Mais velho';
$LNG['custom_p50']					= 'Mais novo';
$LNG['custom_p51']					= 'Oops';
$LNG['custom_p52']					= 'Esta notícia não existe!';
$LNG['custom_p53']					= 'Além disso, à medida que estas regras se aplicam a casos específicos de má conduta, nos reservamos o direito de modificar existente ou adicionar novas regras a nosso critério sem aviso prévio (e sem colocá-las nesta lista) para lidar com qualquer variação de infrações. Também nos reservamos o direito de recusar ou cancelar o serviço de qualquer usuário a qualquer momento.';
