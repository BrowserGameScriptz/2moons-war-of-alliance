...
$LNG['shortTips'] = array (
	106 => '+%s to the level of espionage',
	109 => '+%s%s to armament',
	110 => '+%s%s to shields',
	111 => '+%s%s to armor',
	113 => '+%s%s to energy production',
	115 => '+%s%s of the speed from the Jet engine',
	117 => '+%s%s of the speed from the Pulse Motor',
	118 => '+%s%s speed from engine varp',
	120 => '+%s%s damage to Laser Weapon',
	121 => '+%s%s to damage from Ion Weapon',
	122 => '+%s%s damage to Plasma Weapon',
	199 => '+%s%s damage to Gravitational Guns',
	//NOUVEAU
	101 => '+%s to the slots of the fleets', 
	102 => '+%s%s to mine production',
	103 => '+%s to the maximum number of planets',
	104 => '+%s science for the study of Alliance Development',
	105 => '+%s%s to the speed of flight',
	112 => '+%s science deductions to the alliance',
	116 => '+%s%s to speed from Ionic motor',
	124 => '+%s maximum fleet points in the Expedition <br> +%s%s to the loss probability of the fleet',
	141 => '+%s%s to light armor',
	142 => '+%s%s to Medium Armor',
	143 => '+%s%s to Heavy Armor',
	144 => '+%s increase in misses',
	151 => '+%s%s to Star Trek’s quest chance',
	152 => '+%s%s to the chance to search for Dark Matter',
	153 => '+%s%s to Fleet Search Chance',
	154 => '+%s number of expeditions',
	155 => '+%s%s reduction in misses',
	156 => '+%s%s chance of finding an upgrade <br> The minimum fleet size is %s points',
	157 => '+%s%s chance of finding an upgrade <br> The minimum fleet size is %s points',
	158 => '+%s%s chance of finding an upgrade <br> The minimum fleet size is %s points',
	165 => '+%s to save engines',
	171 => '+%s%s to light shields <br> +%s%s to recovery of light shields',
	172 => '+%s%s to medium shields <br> +%s%s to recovery of medium shields',
	173 => '+%s%s to Heavy Shields <br> +%s%s to Heavy Shield Restoration',
	174 => '+%s%s to restore shields',
);
...
$LNG['tech'] = array(
 ...
 43 => 'Jumpgate',
	...
	114 => 'Hyperdimensional technology',
	115 => 'Jet engine',
	116 => 'Ionic engine',
	117 => 'Pulse motor',
	118 => 'Warp engine',
	...
	143 => 'Heavy armor',
	144 => 'Active Armor',
	151 => 'Star Trek search',
	152 => 'Dark Matter Search',
	153 => 'Search fleet',
	154 => 'Astrophysics',
	155 => 'Accurate shots',
	156 => 'Aggression of Barbarians',
	157 => 'Aggression of Pirates',
	158 => 'Aggression of Ancients',
	165 => 'Saving of engines',
	171 => 'Light shields',
	172 => 'Medium shields',
	173 => 'Heavy shields',
	174 => 'Restoration of shields',
	199 => 'Gravity module',
...
199 => 'Firing a concentrated charge of graviton particles can create an artificial gravity field, which can destroy ships or even moons.',
  ...
  <br><font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> With the destruction of 30-50% of resources spent fall in fragments.</font><br><font color="#B22222"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> Heavy conveyor.</font>',
	...
	<br><font color="#BC8F8F"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> Available on the planets of the galaxy, and the second with the purchase in the premium shop</font>',
	231 => 'M-32 prime fleet of heavy class, has a better protected environment prime fleets. For its structure it has a large stock of boards and the percentage of recovery. Perfect against average fleet and as firepower in major battles.
	<br><br>
	<span style="line-height: 17px; color:#3399CC;"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span> Helpful information:</span><br>
	<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> It used to attacks ennemies.</font>
	<br><font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> With the destruction of 30-50% of resources spent fall in fragments.</font>
