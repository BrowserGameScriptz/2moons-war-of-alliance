...
//----------------------------------------------------------------------------//
//MESSAGES
$LNG['mg_type'][0]    						= 'Spionage';
$LNG['mg_type'][1]    						= 'Spieler';
$LNG['mg_type'][2]   						= 'Allianz';
$LNG['mg_type'][3]    						= 'Schlachten';
$LNG['mg_type'][4]    						= 'System';
$LNG['mg_type'][5]    						= 'Transport';
$LNG['mg_type'][15]   						= 'Expedition';
$LNG['mg_type'][50]							= 'Spielnachrichten';
$LNG['mg_type'][99]   						= 'Bauschleife';
$LNG['mg_type'][100]						= 'Alle';
...
$LNG['al_request_confirmation_message']		= 'Die Anfrage wurde gesendet. Sie erhalten eine Mitteilung der Genehmigung / Ablehnung des Antrags.';
$LNG['al_default_request_text']				= 'Sie haben einen Antrag auf Mitgliedschaft in der Allianz %s gesendet.<br>Bitte warten Sie, bis Sie eine Antwort erhalten, oder Ihre Anwendung entfernen.';
...
$LNG['al_make_ally_tag_required']			= 'Allianz Tag (3 Zeichen)';
